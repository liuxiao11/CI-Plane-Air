...
<div id="container">
    ...
    <div class="air-left">
        ...
        <ul>
            ...
            <li class="air-date active"><a href="<?php echo base_url()?>index/airHis"><img src="<?php echo STATIC_IMG?>dataIndex/carPlane.png" alt="">车载数据查询分析</a></li>
