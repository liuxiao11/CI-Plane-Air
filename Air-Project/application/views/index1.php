...
<head>
    ...
    <style>
        .air-top{position:absolute;width:100%;height:93px;background:url(<?php echo STATIC_IMG?>dataIndex/top11.png) left top no-repeat;background-size: 100% 100%;font-size: 37px;line-height: 93px;text-align: center}
        ...
        .air-center .plane-map{width: 952px;height: 465px;margin:20px auto 0; border-radius: 25px;}
        ...
        .info1 .air-title{margin: 11px 0 0 30px;display: inline-block;font-size: 14px}
