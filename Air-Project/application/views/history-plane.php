...
<head>
    ...
    <title>大气环境综合监测平台-历史数据（无人机）</title>
...
<!--    <script type="text/javascript" src="--><?php //echo STATIC_JS?><!--dataIndex/px2rem.js"></script>-->
    <style>
        ...
        .air-center .center-top {width: 1442px;height: 300px}
...
<div id="container">
    ...
    <div class="air-left">
        ...
        <ul>
            <li class="air-date active"><a href="/index/planeHis"><img src="<?php echo STATIC_IMG?>dataIndex/set-plane.png" alt="">无人机数据查询分析</a></li>
